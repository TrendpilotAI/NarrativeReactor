...
description: The single source of truth for the Narrative Reactor Compound Learning System architecture.
...
This document is the **Single Source of Truth** for the Compound System's technical architecture. It maps the skills, workflows, scripts, and patterns that drive the autonomous engineering capability of Narrative Reactor agents.
