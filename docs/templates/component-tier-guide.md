...
This guide defines the classification criteria for components in the Narrative Reactor codebase. Tiers determine the required depth of documentation in folder-level `README.md` files.
